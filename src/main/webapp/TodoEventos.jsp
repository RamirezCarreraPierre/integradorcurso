...
<%
    ...
    if (generatePdf) {
        ...
        try {
            ...
            document.add(new Paragraph("Lista de Eventos").setFontSize(18).setBold());
            ...
            String sql = "SELECT id, codigo, nombre, fecha, existencia, precio FROM productos WHERE codigo LIKE 'EVT%';";

...
<html>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h6 class="mb-0">Tabla de Tecnologia</h6>
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <form method="post">
                                    ...
                                    <form action="exportarTecnologia.jsp" method="post">
                                        <button type="submit" class="btn btn-success"> <!-- Cambiar clase a btn-success para color verde -->
                                            <i class="fas fa-file-excel"></i> Excel
                                        </button>                                
                                    </form>
                                    <form action="exportarpdfTecnologia.jsp" method="post">
    ...
    <script type="text/javascript">
        function openPdf() {
            window.open('TodoTecnologia.jsp?generatePdf=true', '_blank');
        }
    </script>

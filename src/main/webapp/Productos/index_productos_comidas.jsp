...
<html>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h6 class="mb-0">Tabla de Comidas</h6>
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <form method="post">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <c:forEach var="producto" items="${lista_Comidas}">
                                            <tr>
                                                ...
                                                <td><a href="ProductosController?accion=eliminar_comidas&id=<c:out value="${producto.id}" />">Eliminar</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
    ...
    <script type="text/javascript">
        function openPdf() {
            window.open('TodoComidas.jsp?generatePdf=true', '_blank');
        }
    </script>
</body>
</html>
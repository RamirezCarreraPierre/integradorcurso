...
<html>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h6 class="mb-0">Tabla de Cursos</h6>
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <form method="post">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <c:forEach var="producto" items="${lista_Cursos}">
                                            <tr>
    ...
    <script type="text/javascript">
        function openPdf() {
            window.open('TodoCursos.jsp?generatePdf=true', '_blank');
        }
    </script>
</body>
</html>
...
<%
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        String sql = "SELECT * FROM productos WHERE codigo LIKE 'CUR%';";
        ...
        try {
            ...
            File tempFile = File.createTempFile("Cursos", ".xls");
            ...
            response.setHeader("Content-Disposition", "attachment; filename=Cursos.xls");

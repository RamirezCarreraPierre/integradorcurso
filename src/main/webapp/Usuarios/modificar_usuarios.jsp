            ...
            <div class="content">
               <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="container-fluid pt-4 px-4">
                    <form action="UsuariosController?accion=actualizar_usuarios" method="POST" autocomplete="off">
                        <input type="hidden" id="id" name="id" value="<c:out value="${usuario.id}" />" />
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Modificar Usuario</h6>
                            <div class="mb-3">
                                <label  class="form-label">Codigo</label>
                                <input type="text" class="form-control" id="codigo" name="codigo" value="<c:out value="${usuario.codigo}" />" required />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="contraseña" name="contraseña" value="<c:out value="${usuario.contraseña}" />" required />
                            </div>
                            <div class="mb-3">
                                <label  class="form-label">Cargo</label>
                                <input type="text" class="form-control" id="cargo" name="cargo" value="<c:out value="${usuario.cargo}" />" required />
                            </div>
                            <button id="guardar" name="guardar" type="submit" class="btn btn-primary">Guardar Usuario</button>
                        </div>
                    </form>
                </div>
            </div>

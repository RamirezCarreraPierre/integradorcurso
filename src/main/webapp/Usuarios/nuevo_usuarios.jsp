        ...
        <div class="container-fluid position-relative bg-white d-flex p-0">
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4">
                    <form action="UsuariosController?accion=insertar_usuarios" method="POST" autocomplete="off">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Nuevo Usuario</h6>

                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="codigo" name="codigo" required autofocus="true"
                                       placeholder="codigo">

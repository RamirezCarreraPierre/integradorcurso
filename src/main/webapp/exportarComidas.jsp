...
<%
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        String sql = "SELECT * FROM productos WHERE codigo LIKE 'COM%';";
        ...
        try {
            ...
            File tempFile = File.createTempFile("Productos", ".xls");
            ...
            response.setHeader("Content-Disposition", "attachment; filename=Comidas.xls");
